...
async function seed() {
    try {
        ...
        // ── Roles ──
        const roles = await Role_1.Role.bulkCreate([
            { name: "Supplier" },
            { name: "Wholesaler" },
            { name: "Retailer" },
            { name: "Customer" },
        ...
        // ── Users ──
        const hashedPass = await bcryptjs_1.default.hash("password123", 10);
        const subExpiry = new Date();
        subExpiry.setMonth(subExpiry.getMonth() + 1);
        const expiredDate = new Date();
        expiredDate.setMonth(expiredDate.getMonth() - 1);
        const supplier = await User_1.User.create({
        ...
        const retailer = await User_1.User.create({
        ...
        // ── Categories ──
        const categories = await Category_1.Category.bulkCreate([
        ...
        const products = await Product_1.Product.bulkCreate([
            {
        ...
        // ── Warehouse ──
        const warehouse = await Warehouse_1.Warehouse.create({
        ...
        // ── Inventory ──
        await Inventory_1.Inventory.bulkCreate([
        ...
        // ── Order Items ──
        await OrderItem_1.OrderItem.bulkCreate([
        ...
        // ── Invoices ──
        await Invoice_1.Invoice.bulkCreate([
        ...
        // ── Payments ──
        await Payment_1.Payment.bulkCreate([
        ...
        // ── Shipments ──
        await Shipment_1.Shipment.bulkCreate([
        ...
        // ── Notifications ──
        await Notification_1.Notification.bulkCreate([
        ...
        // ── Withdrawals ──
        await Withdrawal_1.Withdrawal.bulkCreate([
